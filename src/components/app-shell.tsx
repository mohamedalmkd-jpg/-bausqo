...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="min-h-screen bg-muted/40">
    ...
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b bg-background px-4 lg:ml-64 lg:px-8">
      ...
      <div className="hidden lg:block"><p className="text-sm font-semibold">BAUSQO Workspace</p></div>
    ...
    <nav className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-5 border-t bg-background/95 px-2 pb-[env(safe-area-inset-bottom)] shadow-[0_-8px_30px_rgba(15,23,42,.06)] backdrop-blur-xl lg:hidden" aria-label="Mobile Navigation">
