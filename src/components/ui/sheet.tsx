...
interface SheetContentProps
  ...
  /**
   * Removes the modal overlay so the visible page can remain interactive.
   * Use only for navigation drawers that are intentionally non-blocking.
   */
  nonBlocking?: boolean;
}
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "right", className, children, nonBlocking = false, ...props }, ref) => (
  <SheetPortal>
    {!nonBlocking && <SheetOverlay />}
    <SheetPrimitive.Content
      ref={ref}
      data-nonblocking={nonBlocking ? "true" : undefined}
